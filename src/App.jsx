...
const App = () => {
  ...
  return (
    <div className="flex flex-no-wrap">
      ...
      <div
        className={`w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden duration-150 ease-in-out ${
          open ? "-translate-x-64 transition" : "translate-x-0"
        }`}
        id="mobile-nav"
      >
        <div
